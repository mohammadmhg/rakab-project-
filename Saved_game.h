...
public:
    ...
    void saving_gamplay_data(const int,const vector<Gameplay>&,const Rish_Sefid&,const Handle_Data&);
    ...
    void saving_red_cards_data(const int,const vector<City>&);
...
private:
    ...
    ofstream output_red_cards_data;
